...
2. Make sure you are logged in as **crochetwebsite19@gmail.com**.
...
7. You will be prompted to create an App Password. Where it asks for an "App name", type something like: `Crochet Ella Contact Form`.
...
3. Scroll to the very bottom of the `.env` file. You will see these two lines:
   ```env
   EMAIL_USER=crochetwebsite19@gmail.com
